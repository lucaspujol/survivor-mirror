  ...
  return (
    ...
    {(status === 'denied' || status === 'unsupported') && createPortal(
      ...
      >
        ...
        >
          <h2 id="locate-failure-title" style={{ margin: '0 0 8px', fontSize: 15, color: ACCENT_COLOR }}>
    ...
    {hasLastPosition && (
      ...
      >
        <svg viewBox="0 0 24 24" width="20" height="20">
          <line x1="12" y1="1" x2="12" y2="5" stroke={ACCENT_COLOR} strokeWidth="2" />
          <line x1="12" y1="19" x2="12" y2="23" stroke={ACCENT_COLOR} strokeWidth="2" />
          <line x1="1" y1="12" x2="5" y2="12" stroke={ACCENT_COLOR} strokeWidth="2" />
          <line x1="19" y1="12" x2="23" y2="12" stroke={ACCENT_COLOR} strokeWidth="2" />
          <circle cx="12" cy="12" r="6" fill="none" stroke={ACCENT_COLOR} strokeWidth="2" />
          <circle cx="12" cy="12" r="2.5" fill={ACCENT_COLOR} />
        </svg>
      </button>
    )}
  </>
