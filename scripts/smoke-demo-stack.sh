...
payload='{"title":"Offre de vérification","description":"Publiée par le smoke test.","contract_type":"cdi","work_mode":"on_site","time_commitment":"full_time","address":"12 quai de la Fosse, 44000 Nantes"}'
post() {
